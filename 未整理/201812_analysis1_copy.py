...
FLAG_NUM_LIST_P1 = [[[3, 15], [16, 28]],
                    ...
                    [[3, 15], [16, 29]]]
# 刺激開始フラグ番号
FLAG_NUM_LIST_P2 = [[4, 7, 10, 13, 17, 20, 23, 26],
                    [4, 7, 10, 13, 17, 20, 23, 26],
                    [4, 7, 10, 13, 17, 20, 23, 26],
                    [4, 7, 10, 13, 17, 20, 23, 26],
                    [4, 7, 10, 13, 17, 20, 23, 26],
                    [4, 7, 10, 13, 17, 21, 24, 27]]
...
os.chdir(DATAPATH_P)
list_data_p = []
for i_sub in range(len(FILENAME_LIST_P_BIO)):
    # encoding="cp932"を付けないと文字コードエラー
    df_subA_bio = pd.read_csv(FILENAME_LIST_P_BIO[i_sub], encoding="cp932")
    ...
    tmp_numlist = FLAG_NUM_LIST_P2[0]
    ...
    tmp_sessionlist = FLAG_NUM_LIST_P1[0]
    # session1
    ...
    list_data_p.append(df_subA_bio2)
