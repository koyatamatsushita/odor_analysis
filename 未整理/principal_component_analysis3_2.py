...
def main():
    ...
    eta_beta_data_df = pd.concat([eta_data_df, beta_data_df], axis=1)
    eta_beta_data = eta_beta_data_df.values
    ...
    # PCAする(返り値はndarray)
    un_score, non_score = mypca2(q_stan_data, eta_beta_data, odor)
...
def my2Dplot(data1, data2):
    ...
    plt.ylabel("Eta_Beta", fontsize=18)
