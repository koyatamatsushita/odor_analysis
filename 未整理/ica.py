...
def main():
    ...
    plt.subplot(1, 2, 1)
    # プロットする
    plt.scatter(un_score[:, 0], un[0], s=80, c=[0.4, 0.6, 0.9], alpha=0.8, linewidths="1", edgecolors=[0, 0, 0])
    plt.scatter(non_score[:, 0], non[0], s=80, c=[0.5, 0.5, 0.5], alpha=0.8, linewidths="1", edgecolors=[0, 0, 0])
    plt.title("scatter", fontsize=18)
    plt.xlabel("Emotion_PC1", fontsize=18)
    plt.ylabel("ICA_1", fontsize=18)
    correlation_analysis(np.hstack((un_score[:, 0], non_score[:, 0])), np.hstack((un[0], non[0])))
    
    # 2つ目のグラフ
    plt.subplot(1, 2, 2)
    # プロットする
    plt.scatter(un_score[:, 0], un[1], s=80, c=[0.4, 0.6, 0.9], alpha=0.8, linewidths="1", edgecolors=[0, 0, 0])
    plt.scatter(non_score[:, 0], non[1], s=80, c=[0.5, 0.5, 0.5], alpha=0.8, linewidths="1", edgecolors=[0, 0, 0])
    plt.title("scatter", fontsize=18)
    plt.xlabel("Emotion_PC1", fontsize=18)
    plt.ylabel("ICA_2", fontsize=18)
    correlation_analysis(np.hstack((un_score[:, 0], non_score[:, 0])), np.hstack((un[1], non[1])))
...
def my2Dplot(data1, data2):
    ...
    plt.subplot(1, 3, 2)
    # 主成分をプロットする
    plt.scatter(data1[:, 0], data1[:, 2], s=80, c=[0.4, 0.6, 0.9], alpha=0.8, linewidths="1", edgecolors=[0, 0, 0])
    plt.scatter(data2[:, 0], data2[:, 2], s=80, c=[0.5, 0.5, 0.5], alpha=0.8, linewidths="1", edgecolors=[0, 0, 0])
    plt.title("PCA scatter", fontsize=18)
    plt.xlabel("Emotion", fontsize=18)
    ...
    plt.subplot(1, 3, 3)
    # 主成分をプロットする
    plt.scatter(data1[:, 1], data1[:, 2], s=80, c=[0.4, 0.6, 0.9], alpha=0.8, linewidths="1", edgecolors=[0, 0, 0])
    plt.scatter(data2[:, 1], data2[:, 2], s=80, c=[0.5, 0.5, 0.5], alpha=0.8, linewidths="1", edgecolors=[0, 0, 0])
    plt.title("PCA scatter", fontsize=18)
